...
var NUT = {
	URL: "https://oritholdings.hopto.org:8443/rest/zilcode_nut/dbo/data/",
	URL_DB: "https://oritholdings.hopto.org:8443/rest/zilcode_nut/dbo/",
	URL_UPLOAD: "https://oritholdings.hopto.org:8443/rest/upload/",
	URL_TOKEN: "https://oritholdings.hopto.org:8443/rest/token/",
	URL_PROXY: "https://oritholdings.hopto.org:8443/rest/proxy?",
	shortcut: null,
	ds: null,
	access: null,
	appinfo:null,
	...
	createWindowTitle: function (id, divTitle) {
		if (n$.windowid) {
		...
		var canClose = Number.isInteger(id);
		...
		if (canClose) prop.onclick=function () {
