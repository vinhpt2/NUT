	...
	runReport:function(){
		if(num_Year.value&&num_Month.value){
			...
			NUT.ds.select({ url: DailyCheckInoutReport.url +"data/chucvuhabeco",where:[["machucvu","in","TF','TL','GDCN"],["or",["ngaybatdau","is",null],["ngaybatdau","<=",date]],["or",["ngayketthuc","is",null],["ngayketthuc",">=",date]]]},function(res2){
				...
				NUT.ds.select({url:DailyCheckInoutReport.url+"data/chamcong_v",orderby:"stt,sohoso,madiemban",limit:20000,where:[["nam","=",nam],["thang","=",thang],["madoitac","=","HABECO"],["thitruong","=",cbo_ThiTruong.value],vitrilv=="BA"?["vitrilv","=",vitrilv]:["vitrilv","like",vitrilv+"*"],["dulieu","=",chk_Edit.checked?1:0]]},function(res){
